...
def main():
    ...
    for i in range(len(datasets)): # dataset
        ...
        for epoch_id in range(3):
            ...
            for epoch in stage_epochs:
                ...
                with open(eval_path, "r") as f:
                    eval = json.load(f)
                inv_acc_train = round(eval["inv_dist_train"], 3)
                inv_acc_test = round(eval["inv_dist_test"], 3)
        ...
        for epoch_id  in range(3):
            ...
            ppr_test_list = list()
            for epoch in stage_epochs:
                ppr_train = round(eval["ppr_dist_train"][str(epoch)], 3)
                ppr_test = round(eval["ppr_dist_test"][str(epoch)], 3)
